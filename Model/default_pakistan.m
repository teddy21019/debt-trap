...
clear all
filename = 'default_pakistan';                         %output file needed to run simu_1950s.m
...
load tpm_PAK.mat ygrid pai                              %ygrid=endowment grid; associated pai=transition probability matrix
...
% alfa = 0.4;                                         %hours elasticity of nontraded output (rough estimate based on exports as % of GDP)
% hbar = 1;                                           %full-employment hours (normalised to unity)
% a = 0.22;                                           %share of tradables (as a % of total consumption) (based on actual GDP data, imports/consumptions)
