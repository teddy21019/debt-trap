...
%
    ...
    transition_probability_matirx_file = 'tpm_PAK_hp_gdp.mat';
    ...
    fixed_calibration_param = struct();
        ...
        fixed_calibration_param.a       = 0.456;                                     %share of tradables (as a % of total consumption) (based on actual GDP data, imports/consumptions)
    ...
    targets = struct();
        targets.debt_ratio               = 0.44;              % 44.4% per quarter
    ...
    if NEED_CALIBRATE_BETA_AND_LOSS
        ...
        load optimal_grid_PAK.mat optimal_calibration_grid
    end
    
     calibration_param = add_tuning_params(...
            fixed_calibration_param, optimal_calibration_grid);
    
    VFI(calibration_param, 'VFI_PAK_result')
    simu_pakistan
    plot_pakistan
    plot_default_set_pakistan
