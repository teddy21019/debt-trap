% simu_1950s.m
% Produces time series of the model with floating (optimal) exchange-rate policy, optimal capital-control policy, and optimal default policy
% Produces the file simu_1950s.mat
% Run-time: ~15 seconds  
%   
