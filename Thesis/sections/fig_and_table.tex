...
\begin{figure}[h]
    ...
    \emph{Note:} Real GDP growth and inflation for Sri Lanka and GDP is plotted in this figure. The left vertial axis represents the growth in GDP, while the right vertical axis represents the inflation rate, both in percentage.}
\end{figure}
...
\begin{figure}
    ...
    \floatfoot{\emph{Source:} Debt data from IDS Database and \citet*{Horn-Reinhart-Trebesch-21} Database. GDP data from World Bank\\
        \emph{Note:} The gray region represents the non-default set of Sri Lanka, and the white region represents the default set. Black dots in (a) and (b) represents the output-debt pair in the real data, and the gray dots in (b) represents the output-debt pair that excludes the debts from China. Debt here corresponds to the unsecured debt amount per quarter. Important events throughout the timeline are annotated. See Section~\ref{sec: intro-sri} for more detail.
    }
\end{figure}
...
\begin{figure}
    ...
    \floatfoot{\emph{Source:} Debt data from IDS Database and \citet*{Horn-Reinhart-Trebesch-21} Database. GDP data from World Bank\\
        \emph{Note:} The gray region represents the non-default set of Pakistan, and the white region represents the default set. Black dots in (a) and (b) represents the output-debt pair in the real data, and the gray dots in (b) represents the output-debt pair that excludes the debts from China. Debt here corresponds to the unsecured debt amount per quarter. Important events throughout the timeline are annotated. See Section~\ref{sec: intro-pak} for more detail. The years 2011 and 2012 is discarded in (b) for simplicity.
    }
\end{figure}
