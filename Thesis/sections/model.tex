...
To objectively assess this issue, we adopt the up-to-date sovereign debt default model in the literature as a tool for our empirical analysis. Na et al. (2018)使用這個模型探討....；Hinrichsen (2021)使用這個模型探討。
