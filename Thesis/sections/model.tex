...
To objectively assess this issue, we adopt the up-to-date sovereign debt default model in the literature as a tool for our empirical analysis. \citet{Na-18} proposes a model to study the Argentine economy; \citet*{Hinrichsen_2020-chapter4} uses the model to study the enforcementof sovereign debt under war reparations.
