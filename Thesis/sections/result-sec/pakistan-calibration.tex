...
The triplet $\left( \beta, \delta_1, \delta_2 \right)$ is also chosen to match the three equilibrium results:
...
\begin{enumerate}[label = (\roman*)]
    ...
    \footnotetext{
        The \citet{Pakistan-gov-debt-rest} reports a comprehensive list of debt restructuring events in Pakistan. In May 1972, Pakistan interacted with Paris Club for short-term debt relief of \$234 million following the separation of East Pakistan. In June 1974, an arrangement with member countries of Aid-to-Pakistan Consortium agreed to provide another debt relief of \$650 million. By 1981, a political crisis worsened the debt service,  and hence a debt relief was granted by the Consortium. The nuclear test in 1998 by Pakistan led to international sanction and embargo, causing Pakistan to fail its debt service and to seek debt restructuring with Paris Club. The following debt treatments (in 1999 and 2001) from Paris Club were under the ``Houston term'', which differs from the previous debt relief in a sense that it granted a smaller concessional interest rate and longer grace periods \citep{pakistan-debt-rest-list}.
    }
    \item
