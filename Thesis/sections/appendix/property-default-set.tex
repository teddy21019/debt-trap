In Chapter \ref{ch:model}, I introduce the default set given by the decentralized Eaton-Gersovitz model of \citet{Na-18}.
...
\begin{proof}
    ...
    \end{equation}
    The first two terms in \refeq{eq:diff-value-function} resemble this relationship. Since:
    \begin{equation*}
